...
class HeadCountAnalystTest < Minitest::Test
  ...
  def test_if_kidergarten_participation_compares_to_another_district
    assert_equal 0.573, headcount_analyst.kindergarten_participation_rate_variation('ACADEMY 20', :against => 'ADAMS COUNTY 14')
  end
  ...
  def test_if_kidergarten_participation_rate_trends_against_state_average
    ...
    assert_equal district_trend, headcount_analyst.kindergarten_participation_rate_variation_trend('ACADEMY 20', :against => 'COLORADO')
  end

  def test_if_hs_graduation_avg_compares_to_state_average
    assert_equal 1.194, headcount_analyst.high_school_graduation_variation("ACADEMY 20", :against => 'COLORADO')
  end
  ...
  def test_does_kinder_participation_correlate
    assert_equal true, headcount_analyst.kindergarten_participation_correlates_with_high_school_graduation(for: 'ACADEMY 20')
  end

  def test_do_statewide_percentages_correlate_with_grad_rates
    assert_equal true, headcount_analyst.kindergarten_participation_correlates_with_high_school_graduation(for: 'STATEWIDE')
  end
  ...
  def test_does_kinder_participation_correlate_with_a_subset_of_districts
    ...
    assert_equal true, headcount_analyst.kindergarten_participation_correlates_with_high_school_graduation(:across => districts)
  end
end
